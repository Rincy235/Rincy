...
public class WebDriverUtility {
	...
	public void SelectOption(WebElement driver, String option)
	{
	...
	/**
	 * this methods enables user to handle drop-down using index
	 * @param elament
	 * @param index
	 */
	...
	/**
	 * This method is used for scrolling action in a web-page
	 * @param driver
	 * @param element
	 */
